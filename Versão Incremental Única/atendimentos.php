...
{
    $senhaFormatada = $row['sigla_senha'] . str_pad($row['num_senha'], 3, '0', STR_PAD_LEFT);
...
{
    $sql = "SELECT a.id, s.descricao AS nome_servico, a.sigla_senha, a.num_senha, p.descricao AS nome_prioridade, a.prioridade_id, a.dt_cheg, a.dt_cha, a.dt_ini, u.nome AS nome_usuario
            FROM atendimentos a
